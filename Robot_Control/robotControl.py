...
class robot:
    def __init__(self, cap, arduino, verbose, debug):
        ...
        self.bodyMotor = servo(self.cap, self.arduino,self.verbose,self.debug,0,560,2330,0,pi,1) #0 is right facing, pi is left facing
        ...
        self.headMotor = servo(self.cap, self.arduino,self.verbose, self.debug,5,550,2340,0,pi,1) #0 is right, pi is left
